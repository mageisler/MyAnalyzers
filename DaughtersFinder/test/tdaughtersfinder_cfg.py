...
# list of input files
primInputFiles = cms.untracked.vstring('file:/user/geisler/RelValTTbar_PU_START53_GEN-SIM-RECO.root')
secInputFiles = cms.untracked.vstring('file:/user/geisler/RelValTTbar_PU_START53_GEN-SIM-DIGI-RAW-HLTDEBUG.root')
...
# output file
outputFile = 'Tdaughterfinder.root'
...
process.tdf = cms.EDAnalyzer('ZDaughtersFinder',
...
process.pNew += getattr( process, 'tdf' )
